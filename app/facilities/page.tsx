...
export const metadata = pageMetadata({ title: "Equestrian Facilities Near Seymour", description: "Explore Goodspell Park's stables, arena, horse walker, all-weather track, paddocks and equine pool at Whiteheads Creek near Seymour, Victoria.", path: "/facilities", keywords: ["equestrian facilities Seymour", "horse stables Victoria", "horse arena Seymour", "equine pool Victoria", "Goodspell Park facilities"] });
