...
export const metadata: Metadata = { title: "Book A Lesson", description: "Enquire about private showjumping lessons with Jamie or Sue Coman." };
const lessons = [
...
export default function BookOnlinePage() { return <PageShell>
  <InnerHero eyebrow="Coaching at Goodspell Park" title="One hour. One partnership. Clear next steps." copy="Private showjumping lessons tailored to where you and your horse are today." image="/images/pages/lesson-sue.jpg" imageAlt="Private showjumping coaching" />
